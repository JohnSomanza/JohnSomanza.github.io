...
const Hero = () => {
  ...
  const two = <h2 className="big-heading">John Somanza.</h2>;
  const three = <h3 className="big-heading">I monitor and mitigate cyber threats.</h3>;
  const four = (
    <>
      <p>
